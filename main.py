...
class main():
    def __init__(self):
        ...
        self.config_graph_frame.pack(side = LEFT,pady=self.padd_y) 
        ...
        self.path_label.pack(pady=self.padd_y, anchor ="e")
        ...
        self.path_box.pack(pady=self.padd_y)
        # Selecti file button
        
        # title
        self.title_label = Label(self.text_frame, text="Title: ")
        self.title_label.pack(pady=self.padd_y, anchor ="e")
        ...
        self.title_box.pack(pady=self.padd_y)

        #nombre del eje y
        self.x_label = Label(self.text_frame, text="X-axis title:")
        self.x_label.pack(pady=self.padd_y, anchor ="e")
        ...
        self.x_name_box.pack(pady=self.padd_y)

        #nombre del eje x
        self.y_label = Label(self.text_frame, text="Y-axis title:")
        self.y_label.pack(pady=self.padd_y, anchor ="e")
        ...
        self.domain_box.pack(pady=self.padd_y)

        #legenda de la grafica
        self.legend_label = Label(self.text_frame, text="Legend")
        self.legend_label.pack(pady=self.padd_y, anchor ="e")
        ...
        self.color_curve_label.pack(pady=self.padd_y, anchor ="e")
        ...
        self.color_equation_button.pack(pady=self.padd_y, anchor = "sw")

        #contenido del frame de estilos ------------------------------------
        self.grid_label = Label(self.text_frame, text = "grid")
        self.grid_label.pack(pady=self.padd_y, anchor ="e") 
        ...
        self.grid = Checkbutton(self.input_frame,
				    ...
				    height=1,
				    width=1)
        self.grid.pack(pady=self.padd_y, anchor = "sw")

        self.color_label = Label(self.text_frame, text="Color Points:")
        self.color_label.pack(pady=self.padd_y)
        ...
        self.size_point.pack(pady=self.padd_y)
